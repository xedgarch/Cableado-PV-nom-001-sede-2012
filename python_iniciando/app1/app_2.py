...
if st.checkbox("Mostrar tablas de referencia"):
    st.write("Tabla de factores de corrección por temperatura: tabla_310_15_b_2_a")
    st.dataframe(tabla_310_15_b_2_a)

    st.write("Tabla de factores de corrección por número de conductores: tabla_310_15_b_3_a")
    st.dataframe(tabla_310_15_b_3_a)

    st.write("Tabla de calibres de conductores (Cobre): tabla_310_15_b_16_cobre")
    st.dataframe(tabla_310_15_b_16_cobre)

    st.write("Tabla de calibres de conductores (Aluminio): tabla_310_15_b_16_aluminio")
