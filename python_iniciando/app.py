...
if st.checkbox("Mostrar tablas de referencia"):
    ...
    st.write("Tabla de factores de corrección por distancia sobre el suelo de la canalización: Tabla 310-15(b)(3)(c)")
    st.dataframe(tabla_310_15_b_3_c)

    st.write("Tabla de factores de corrección por temperatura: Tabla 310-15(b)(2)(a)")
    st.dataframe(tabla_310_15_b_2_a)

    st.write("Tabla de factores de corrección por número de conductores: Tabla 310-15(b)(3)(a)")
    st.dataframe(tabla_310_15_b_3_a)

    st.write("Tabla de calibres de conductores (Cobre): Tabla 310-15(b)(16)-cobre")
    st.dataframe(tabla_310_15_b_16_cobre)

    st.write("Tabla de calibres de conductores (Aluminio): Tabla 310-15(b)(16)-aluminio")
    st.dataframe(tabla_310_15_b_16_aluminio)

    st.write("Tabla para conversion mm2 a AWG: Tabla __________")
    st.dataframe(mm2_to_AWG)

    st.write("Tabla para tamaño de conductor PE cobre: Tabla Tabla 250-122-Cobre")
    st.dataframe(tabla_250_122_cobre)

    st.write("Tabla para tamaño de conductor PE alumnio: tabla 250-122-Aluminio")
    st.dataframe(tabla_250_122_aluminio)
